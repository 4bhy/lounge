  ...
  return (
    <div>
      ...
      <div className='flex justify-center'>
        <div className="bar mt-10 w-650 sm:w-8/12 lg:w-auto md:w-11/12 bg-white shadow-md rounded-full flex justify-center text-sm">
          <div className="location w-full px-4 md:px-6 py-2 sm:w-8/12 lg:w-auto md:w-11/12 rounded-full transition-colors duration-250 ease">
          ...
          <div className="check-in w-full sm:w-8/12 lg:w-auto md:w-11/12px-4 md:px-6 py-2 rounded-full transition-colors duration-250 ease">
          ...
          <div className="check-out w-full sm:w-6/12 lg:w-auto md:w-11/12 px-4 md:px-6 py-2 rounded-full transition-colors duration-250 ease">
          ...
          <div className="guests w-full sm:w-8/12 lg:w-auto md:w-11/12 px-4 md:px-6 py-2 rounded-full transition-colors duration-250 ease">
          ...
          <div className="guests w-full sm:w-8/12 lg:w-auto md:w-11/12 px-4 md:px-6 py-2 rounded-full transition-colors duration-250 ease">
            <button onClick={submitHandler} className="mt-3 bg-green-600 text-white rounded-full text-xs px-4 py-1"><i class="fa fa-search" aria-hidden="true"></i></button>
          </div>
        </div>
      </div>
      ...
      {
        filteredProducts && <div className='mt-8 mb-4'>
