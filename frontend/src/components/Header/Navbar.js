...
const Navbar = () => {
  ...
  return (
    <div>
        <nav class="flex justify-between px-20 py-5 items-center bg-white-100 -z-0">
        <Link to="/"><h1 class="text-xl text-gray-800 font-bold">to.be.named</h1></Link> 
          <div class="flex items-center">
            ...
            <ul class="flex items-center space-x-6">
              ...
              {
                userInfo? (
                  // <Link to="/dashboard"><i class="fa-solid fa-user-plus"></i></Link>
                  <BasicMenu/>
                  ):(    <Link to="/login">
                <li class="font-semibold text-gray-700">Login</li></Link>)
              }
              {
                !userInfo &&
              <Link to="/register"><li class="font-semibold text-gray-700">Register</li></Link>
