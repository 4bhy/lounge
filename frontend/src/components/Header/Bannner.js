    ...
    <div class="max-w-xl text-center sm:text-left">
      ...
      <div class="mt-8 flex flex-wrap gap-4 text-center">
       <Link to="/findmore"><a
        ...
        <a
          href="#"
          class="block w-full rounded bg-gray-300 px-12 py-3 text-sm font-medium text-green-600 shadow hover:text-green-700 focus:outline-none focus:ring active:text-green-500 sm:w-auto"
        >
          Learn More
        </a>
      </div>
