...
{/* <div class="flex justify-center items-center bg-white">
	...
	<div class="container mx-auto my-4 px-4 lg:px-20">
		...
		<div class="w-full p-14 my-4 md:px-12 lg:w-9/12 lg:pl-20 lg:pr-40 mr-auto rounded-2xl shadow-2xl">
			<div class="flex">
				<h4 class="font-bold uppercase">Send us a <br /> message</h4>
			</div>
			<div class="grid grid-cols-1 gap-5 md:grid-cols-2 mt-5">
				<input class="w-full bg-gray-100 text-gray-900 mt-2 p-3  rounded-2xl focus:outline-none focus:shadow-outline"
            ...
            type="email" placeholder="Address" />
				<input class="w-full bg-gray-200 text-gray-900 mt-2 p-3 rounded-2xl focus:outline-none focus:shadow-outline"
			...
			<div
				...
				<div class="flex flex-col text-white">
					<h2 class="font-bold uppercase my-4">Drop in our office</h2>
